...
var Module = typeof Utils !== 'undefined' ? Utils : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_findContours')) {
        Object.defineProperty(Module['ready'], '_findContours', { configurable: true, get: function() { abort('You are getting _findContours on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_findContours', { configurable: true, set: function() { abort('You are setting _findContours on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 'wasm_utils.wasm';
...
/** @type {function(...*):?} */
var _findContours = Module["_findContours"] = createExportWrapper("findContours");
